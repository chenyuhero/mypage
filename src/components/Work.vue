			  	...
			  	<div>
			  		<div class="workitem">
						...
						<div id="discribe">
							...
							<div>
								<span>
								端在线音播放器乐，具备播放、暂停、动态显示歌词、调节音量等基本功能，可以通过点击相应歌曲频道的切换或选择，以及歌曲的切换。通过函数限流 处理请求重复发送。用以应对复杂场景进行性能优化。
								</span>
							</div>
					...
					<div class="workitem">
						...
						<div id="discribe">
							...
							<div>
								<span>
								用瀑布流的布局方法，将从新浪新闻api获取到的数据呈现到页面中，使用原生JS实现懒加载、自动加载、预加载，使用媒体查询、Flex 布局构建的新闻页面。
								</span>
							</div>
					...
					<div class="workitem">
						...
						<img class="img" src="../assets/todo.png"> </img>
							...
							<div>
								<span>
								一个操作简便的基于Vue的TodoList应用， 支持多用户在线注册、登录账号等功能. 数据同步到Leancloud，支持用户进行事件的增删查改，数据更新提醒。
								可以根据事情的紧急程度进行划分，对已完成事件进行归类。通过模块的划分和相互通信，降低了组件的耦合度，提高了复用性。
					...
					<div class="workitem">
						...
						<div id="discribe">
							...
							<div>
								<span>
								基于Vue的一个在线简历编辑器，可以简单的对个人信息等建立需要的资料进行编辑，支持多用户在线注册、登录账号等功能. 数据同步到Leancloud，支持用户进行个人资料的增删查改。并且实现了简历的主题色选择的功能。
								</span>
							</div>
					...
					<div class="workitem">
						...
						<div id="discribe">
							...
							<div>
								<span>
								从豆瓣api获取数据的手机端应用，能够通过懒加载的方式获取的评分最高的250部电影，以及北美电影榜单Top10，以及电影搜索的功能。
								</span>
							</div>
